(function () {
    ...
    initPhotoSwipeFromDOM('.entity-gallery');
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                if (result) {
                    $.ajax({
                        method:"GET",
                        url: $("#delete_document_url").html() + "&file_name=" + file.name,
                        success: function () {
...
$(document).ready(function () {
    ...
    if ($("#maindropzone") !== undefined) {
        ...
        Dropzone.options.maindropzone = {
            init: function () {
                ...
                if ($("#entity_document_url") !== undefined) {
                    $.getJSON($("#entity_document_url").html(), function (data) {
    ...
    //slick carrousel entity gallery
